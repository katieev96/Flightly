        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Aircrafts_AircraftManufacturers_AircraftManufacturerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserFlights_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Approaches = table.Column<double>(nullable: false),
                    ...
                    SoloTime = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_flightInfos_Aircrafts_AircraftId",
                        column: x => x.AircraftId,
                        principalTable: "Aircrafts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_flightInfos_UserFlights_FlightId",
                        column: x => x.FlightId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Aircrafts_AircraftManufacturerId",
                table: "Aircrafts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_flightInfos_AircraftId",
                table: "flightInfos",
                column: "AircraftId");

            migrationBuilder.CreateIndex(
                name: "IX_flightInfos_FlightId",
                table: "flightInfos",
                column: "FlightId");
